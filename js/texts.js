...
const ANNOTATE = [
  ...
  },
  {
    ...
    prompt: "Find the <em>small action</em> that shows Mei forgives him, without saying so.",
    target: ["moved her bag so there was room on the bench"],
    decoys: [
      { phrase: "She did not run to him", why: "That shows Mei holding back. It is not forgiveness yet. Look at what she actually does next." },
      { phrase: "Mei did not stand up", why: "This is what she does NOT do. The forgiveness is in the one thing she does do." }
    ],
    miss: "Read the last paragraph. What is the only thing Mei actually does?",
    explain: "Moving her bag makes room for him. The writer never says “she forgave him”: the action says it. The bag she clamped in fear at the start is now moved to let him in."
  }
];
...
const QUESTIONS = [
  ...
  {
    skill: "Effect of language",
    q: "“She checked it again, in case the first time had not counted.” What is the effect of this sentence?",
    opts: [
      { t: "It shows her anxiety makes her act in ways that aren’t logical", ok: true, why: "Right. Checking “in case the first time had not counted” makes no sense, and that is the point. Worry has taken over. It is almost funny, which makes it sadder." },
      { t: "It shows her phone is broken and messages are not arriving", why: "Nothing suggests the phone is faulty. The joke is that a phone check always “counts”. The problem is Mei’s worry, not the phone." },
      { t: "It shows Mei is bored", why: "Bored people check their phones too, but the phrase “in case the first time had not counted” shows desperate hope, not boredom." },
      { t: "It shows she is expecting a message from a friend, not her grandfather", why: "The whole passage is about waiting for her grandfather. No friend is mentioned. Stay inside the text." }
    ]
  },
  {
    skill: "Inference",
...
const EVIDENCE = [
  {
    quote: "her school bag clamped between her ankles as if someone might steal it",
    opts: [
      { t: "Mei feels anxious and on guard", ok: true, why: "Right. “Clamped” shows tension, and “as if” tells us the thief is imagined. The quote proves how Mei feels, not what is really happening." },
      { t: "The ferry terminal is dangerous", why: "“As if” means no one is actually stealing anything. The quote is evidence of Mei’s feelings, not of real danger. A claim must match what the quote can prove." },
      { t: "Mei is well organised", why: "Holding a bag tightly isn’t about organisation. The key word “clamped” points to worry." },
      { t: "Her bag contains something valuable", why: "The text never tells us what is in the bag. You can’t use a quote to prove something it doesn’t mention." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "Mei is desperate for news.",
    quote: "She checked it again, in case the first time had not counted.",
    opts: [
      { t: "Mei looks at her phone a second time to see whether her grandfather has sent her a message explaining where he is, what has happened and why he is so late.", why: "Retelling. It describes the action but not why the writer wrote it this way. The key phrase, “in case the first time had not counted”, is ignored." },
      { t: "“In case the first time had not counted” shows Mei knows checking again is pointless, yet she does it. Worry has beaten logic.", ok: true, why: "Strong. It quotes the exact phrase that matters, explains what is odd about it (a phone check always counts), and shows how that proves desperation." },
      { t: "The writer repeats the word “checked” in this part of the story in order to create an effect on the reader and make the writing more interesting.", why: "“Create an effect” and “more interesting” are empty phrases: they could describe any sentence ever written. Which effect? Name it and connect it to the claim." },
      { t: "This quote shows how Mei is feeling at this point in the story, which makes the reader feel sorry for her and want to keep reading to find out what happens next.", why: "Too vague. “How Mei is feeling” never says which feeling, and no words from the quote are explained. A strong explanation is specific." }
    ]
  },
  {
...
const ANNOTATE = [
  ...
  {
    skill: "Irony",
    prompt: "Find the phrase that makes something <em>sinister sound pleasant</em>.",
    target: ["the colour of fresh starts"],
    decoys: [{ phrase: "never, ever dropped their spoons", why: "This shows how scared the new family is, but it is not a pleasant phrase covering something dark. Look at how the door is described." }],
    miss: "Read about Mr Okafor’s door. How is the colour white described?",
    explain: "A man has vanished, yet his door is painted “the colour of fresh starts”. The cheerful phrase sounds like the authorities’ own language, and the gap between the nice words and the dark event is chilling."
  },
  {
    skill: "Personification",
...
const QUESTIONS = [
  ...
  },
  {
    ...
    q: "What is the effect of the paragraph “Green. Green. Amber.”?",
    opts: [
      { t: "It builds tension by showing the danger rising, step by step", ok: true, why: "Right. A paragraph of three single words slows the reader down to the narrator’s pace of watching. Two safe greens make the change to amber feel like a jolt." },
      { t: "It shows the narrator enjoys watching the badge change colour", why: "Amber means danger is close. The narrator is watching out of fear, not enjoyment." },
      { t: "It makes the story more cheerful by adding colour", why: "These colours work like traffic lights: green is safe, amber is a warning. They add tension, not cheer." },
      { t: "It tells the reader that the badge is broken", why: "The badge is working: the drip is making sound, so it reacts. That is exactly what makes it frightening." }
    ]
  },
  {
    skill: "Character",
...
const EVIDENCE = [
  ...
  {
    quote: "We talk with our hands at dinner. We have become very good at it.",
    opts: [
      { t: "The family has adapted so completely that silence feels normal", ok: true, why: "Right. “Very good at it” shows long practice. Something frightening has become an everyday skill, which is part of what makes the world disturbing." },
      { t: "The members of the family are deaf and cannot hear each other", why: "A misreading. They sign because speaking is dangerous, not because they cannot hear. Tobi laughs and the narrator listens to the drip." },
      { t: "The family does not like talking to each other at dinner time", why: "They still communicate every dinner, just silently. The quote shows closeness under pressure, not dislike." },
      { t: "The family enjoys learning new languages", why: "The quote is about survival under the rules. There is no sign that it is a hobby." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "The narrator is brave.",
    quote: "press my ear to the cold wall",
    opts: [
      { t: "The narrator feels cold because it is night-time in the city and the flat does not seem to have any heating turned on, so the walls are freezing to touch.", why: "A misreading. “Cold” describes the wall, and it matters because of how unwelcoming it makes the danger feel." },
      { t: "The narrator moves towards danger, not away. “Cold” makes the wall unwelcoming, yet they press closer anyway: that is courage.", ok: true, why: "Strong. It explains the action, the word “cold” and how together they prove bravery." },
      { t: "This shows the reader what kind of person the narrator is and adds a lot to the atmosphere and the tension of this part of the story for the reader.", why: "Vague. What kind of person? Which words? “Adds to the atmosphere” explains nothing." },
      { t: "The writer uses sensory language in this sentence, describing the sense of touch when the narrator’s ear meets the wall.", why: "Correct label, but it stops before saying how the touch detail shows bravery." }
    ]
  }
];
...
const ANNOTATE = [
  ...
  {
    skill: "Everyday comparison",
    prompt: "Find the comparison with an <em>everyday object</em> that helps readers imagine the weight.",
    target: ["less than an apple"],
    decoys: [{ phrase: "the size of a human thumb", why: "That is an everyday comparison too, but it describes the size of the babies, not the weight of an adult." }],
    miss: "Find the sentence about how much they weigh.",
    explain: "Few readers can imagine 120 grams, but everyone has held an apple. Comparing a number with something familiar makes the fact easy to picture."
  },
  {
    skill: "Exclamation",
...
const QUESTIONS = [
  ...
  {
    skill: "Use of numbers",
    q: "Why does the writer say they can jump “over 30 times their own body length”?",
    opts: [
      { t: "It turns a number into an impressive comparison with the animal’s own size", ok: true, why: "Right. Four metres is not huge on its own, but compared with a 15-centimetre body it becomes remarkable." },
      { t: "To give scientists an exact measurement they can record in their notes", why: "“Over 30 times” is a rounded comparison for readers, not a precise scientific measurement." },
      { t: "To prove they jump further than humans", why: "Humans are not compared here. The comparison is with the marmoset’s own body." },
      { t: "To show that the earlier figure of four metres in the text was wrong", why: "The two figures agree: four metres is about 30 times a 14–16 centimetre body." }
    ]
  },
  {
    skill: "Inference",
...
const EVIDENCE = [
  ...
  {
    quote: "they can move along slender branches higher into the trees than other monkeys",
    opts: [
      { t: "Their small size is an advantage", ok: true, why: "Right. Being tiny lets them reach places, and food, that bigger monkeys cannot." },
      { t: "Other monkeys cannot climb trees", why: "Other monkeys climb too; they just can’t go as high on thin branches." },
      { t: "Pygmy marmosets are the fastest monkeys", why: "The quote is about height, not speed." },
      { t: "Branches break under every monkey", why: "Only thin branches would break under heavier monkeys. The quote doesn’t say all branches break." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "Newborn marmosets are extremely small.",
    quote: "each about the size of a human thumb",
    opts: [
      { t: "The female pygmy marmoset usually has two babies at a time, and then the male helps to look after them by carrying them on his back.", why: "Retelling a nearby fact. Explain the size comparison." },
      { t: "The writer compares the babies to part of the body.", why: "An observation. Why does this comparison work?" },
      { t: "A thumb is a small part of a hand, and an adult fits in a hand. So the babies are tiny even for marmosets.", ok: true, why: "Strong. It links back to the adult fitting in a hand and shows how small the babies must be." },
      { t: "This shows that the baby pygmy marmosets actually look like thumbs when they are born, because they are the same shape and colour.", why: "A literal misreading. The comparison is about size, not appearance." }
    ]
  }
];
...
const ANNOTATE = [
  ...
  {
    skill: "Revealing detail",
    prompt: "Find the detail that reveals how <em>empty</em> Miss Brill’s weekday life is.",
    target: ["If he’d been dead she mightn’t have noticed for weeks"],
    decoys: [{ phrase: "She had got quite used to the frail head on the cotton pillow", why: "This shows a habit, but the shocking detail comes in the next sentence." }],
    miss: "Look at the paragraph about the old invalid gentleman.",
    explain: "Her weekday company is a man who sleeps while she reads, so absent that he could be dead without her noticing. The detail quietly shows how little real human contact she has."
  },
  {
    skill: "Simile",
...
const QUESTIONS = [
  ...
  {
    skill: "Ending",
    q: "What does the final line, “she thought she heard something crying”, suggest?",
    opts: [
      { t: "She is crying but can’t admit it, so it seems to come from the fur", ok: true, why: "Right. “Something” and “thought she heard” create distance. Mansfield shows the pain without letting Miss Brill face it directly." },
      { t: "The fur necklet is really alive and is crying quietly inside its cardboard box on the bed", why: "A literal reading. The fur is an object; the crying suggests Miss Brill’s own feelings." },
      { t: "A baby is crying in another flat in Miss Brill’s building", why: "Nothing mentions neighbours. The crying comes as she closes the fur’s box." },
      { t: "Miss Brill feels happy and peaceful at the end of her day", why: "She skips her treat, sits for a long time and hears crying. The mood is deep sadness." }
    ]
  },
  {
    skill: "Mood",
...
const EVIDENCE = [
  {
    quote: "No doubt somebody would have noticed if she hadn’t been there",
    opts: [
      { t: "Miss Brill badly wants to believe she matters to others", ok: true, why: "Right. “No doubt” sounds confident, but nothing shows anyone would notice. It reveals her wish to be important." },
      { t: "Everyone in the Jardins Publiques knows Miss Brill by name and looks out for her", why: "No one speaks to her. The quote is her belief, not a fact." },
      { t: "Miss Brill is a famous actress who performs in the town’s theatre", why: "The “play” is imaginary. She teaches English and reads to an invalid." },
      { t: "Miss Brill often misses her Sunday visits", why: "She comes “every Sunday” and makes “a point” of arriving on time." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "The couple’s words are especially cruel.",
    quote: "that stupid old thing at the end there",
    opts: [
      { t: "“Thing” strips Miss Brill of being a person, and “stupid old” adds contempt. She had cast them as hero and heroine, so the insult wrecks her play.", ok: true, why: "Strong. It explains the word choices and links them to her imagined play." },
      { t: "The boy is talking about Miss Brill, who is sitting at the end of the bench, and he says that he doesn’t want her there while he talks to the girl.", why: "Retelling. How do the words make it cruel?" },
      { t: "I think the boy is very rude and should apologise to Miss Brill, because it is not nice to talk about people like that when they can hear you.", why: "A personal response. Analyse Mansfield’s words." },
      { t: "The boy is really talking about an old object left at the end of the bench, not about Miss Brill, which is why he calls it a thing.", why: "A misreading. “Why does she come here at all” shows he means Miss Brill." }
    ]
  },
  {
...
const ANNOTATE = [
  {
    skill: "Word choice",
    prompt: "Find the adjective in the introduction showing the writer <em>admires</em> Einstein.",
    target: ["extraordinary physicist"],
    decoys: [{ phrase: "Albert Einstein was born in Germany", why: "That is a plain fact. Look for a describing word that shows an opinion." }],
    miss: "Look at the introduction before fact number 1.",
    explain: "“Extraordinary” means far beyond ordinary. It tells readers from the very first line that Einstein was special, before any facts prove it."
  },
  {
    skill: "Metaphor",
...
const QUESTIONS = [
  ...
  {
    skill: "Tone",
    q: "What effect do informal phrases like “wowed the world” have?",
    opts: [
      { t: "They create a friendly, exciting tone that suits young readers", ok: true, why: "Right. Chatty words make science feel thrilling and easy to connect with." },
      { t: "They make the whole article sound formal, serious and academic", why: "“Wowed” is informal, the opposite of academic." },
      { t: "They show the writer is being sarcastic and making fun of Einstein", why: "The writer clearly admires him. There is no sarcasm." },
      { t: "They show the writer is angry", why: "Nothing about “wowed” suggests anger." }
    ]
  },
  {
    skill: "Finding information",
...
const EVIDENCE = [
  {
    ...
    opts: [
      { t: "Setbacks didn’t stop Einstein succeeding", ok: true, why: "Right. He failed at first but was still accepted and went on to change science." },
      { t: "Einstein was bad at maths when he was young", why: "He had exceptional maths results. The failure was in other parts of the exam." },
      { t: "The entrance exam for the school in Zürich was unfair", why: "The quote doesn’t say anything about fairness." },
      { t: "Einstein never went to university", why: "He was accepted in 1896 and later earned a PhD." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "Einstein’s interest in physics was a passion, not just a talent.",
    quote: "fell in love with physics",
    opts: [
      { t: "Einstein started to study physics when he was young, after his father gave him a compass as a present and he wondered how the needle moved.", why: "Retelling. How do the words show passion?" },
      { t: "This shows Einstein didn’t have any time for his friends or family when he was a boy, because the only thing he cared about was physics.", why: "Overclaiming. The phrase shows enthusiasm, nothing about friends." },
      { t: "Falling in love suggests excitement and devotion. Physics was something he adored, not just a subject he was good at.", ok: true, why: "Strong. It explains the metaphor and links it to passion." },
      { t: "The writer uses a metaphor in this sentence.", why: "Correct label, but what does it show?" }
    ]
  },
  {
...
const ANNOTATE = [
  ...
  {
    skill: "Inference clue",
    prompt: "Find the detail about <em>closing the jaw</em> that matters at the end.",
    target: ["binding a handkerchief about the chin to close the jaw"],
    decoys: [{ phrase: "He washed the body, combed the hair", why: "Part of the same careful preparation, but it is not the detail the ending depends on." }],
    miss: "Look at the paragraph where he prepares the body.",
    explain: "A jaw bound shut cannot bite. Bierce puts the detail in early and quietly, so the last line rewards readers who remember it."
  },
  {
    skill: "Suspense",
...
const QUESTIONS = [
  ...
  {
    skill: "Inference",
    q: "What can we work out that Murlock never says?",
    opts: [
      { t: "His wife was still alive when he laid her on the table", ok: true, why: "Right. The bitten ear proves she fought. The illness had left her in a state he mistook for death." },
      { t: "The panther had been living inside the cabin already", why: "It comes to the window, which is how it gets in and out." },
      { t: "Murlock shot his own wife by accident in the darkness of the cabin", why: "The wounds are teeth wounds, at her throat." },
      { t: "The cry he heard was made by a neighbour outside", why: "There are no neighbours. The narrator says so." }
    ]
  },
  {
    skill: "Ending",
...
const EVIDENCE = [
  ...
  {
    quote: "Something besides years had had a hand in his ageing",
    opts: [
      { t: "Grief has aged him faster than time could", ok: true, why: "Right. He looks seventy at fifty, and the sentence points at a cause the narrator will not name yet." },
      { t: "He has been ill for most of his adult life", why: "No illness of his is mentioned anywhere." },
      { t: "Hard work in the forest has worn him out", why: "The line separates the cause from ordinary years of labour." },
      { t: "He has lied about his real age to the hunters", why: "The narrator gives both ages without any deceit." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "The last line does its work by saying less.",
    quote: "Between the woman’s teeth was a fragment of the animal’s ear",
    opts: [
      { t: "When Murlock lights a match he finds his wife’s body on the floor in the corner of the room with her throat torn.", why: "Retelling. What does the very last detail prove?" },
      { t: "Only living teeth could hold that. The reader works out that she was alive, and Bierce stops before the thought is said aloud.", ok: true, why: "Strong. It explains the inference and why silence is stronger here." },
      { t: "The sentence shows that the panther was injured in the struggle and ran off into the forest without its ear.", why: "True but beside the point. Whose teeth held it?" },
      { t: "The story ends with a short sentence about the woman’s teeth, and short sentences at the end of a story are used to make a reader stop.", why: "An observation. What does the reader conclude?" }
    ]
  },
  {
...
const ANNOTATE = [
  ...
  {
    skill: "Atmosphere",
    prompt: "Find the moment the candles <em>change the room</em>.",
    target: ["the room grew a new ceiling, low and gold"],
    decoys: [{ phrase: "They found the candles in the drawer with the batteries", why: "That is where the candles came from, not what they do to the room." }],
    miss: "Look for what happens after the candles are stood in saucers.",
    explain: "Candlelight only reaches so far, so the dark becomes a lower ceiling. The room shrinks, and a shrinking room turns from frightening to cosy."
  },
  {
    skill: "Imagery",
...
const QUESTIONS = [
  ...
  {
    skill: "Ending",
    q: "Why is Amira “a little sorry” at the end?",
    opts: [
      { t: "The blackout gave her something the normal evening does not", ok: true, why: "Right. The candles made a small warm cave with the three of them in it. The bright kitchen takes that back." },
      { t: "She is worried that the power will fail a second time", why: "Nothing suggests she expects it to happen again." },
      { t: "She had wanted to keep the candles for her own bedroom instead", why: "The candles matter for the evening, not as objects." },
      { t: "She is annoyed that the storm ended as quickly as it did", why: "Her feeling is about the room, not about the weather." }
    ]
  },
  {
    skill: "Summary",
...
const EVIDENCE = [
  ...
  {
    quote: "the calm voice she used for cut knees and lost shoes",
    opts: [
      { t: "The mother treats the blackout as an everyday problem", ok: true, why: "Right. The same voice as for scraped knees puts the power cut in the category of small fixable things." },
      { t: "The mother has not noticed that the lights are out", why: "She gives an instruction about it immediately." },
      { t: "The children are often hurt or losing their things", why: "The examples describe her voice, not their week." },
      { t: "The mother is hiding how frightened she really is by it", why: "Nothing suggests fear behind the calm." }
    ]
  },
  {
...
const EXPLAIN = [
  ...
  {
    claim: "The blackout connects the family to their neighbours.",
    quote: "torches were moving behind other people’s curtains, small and warm, like fish in a dark aquarium",
    opts: [
      { t: "Amira looks out of the window and sees other people in the block moving about their flats holding torches in the dark.", why: "Retelling. Why compare them to fish?" },
      { t: "Fish in a tank are calm and watched from outside. Every window holds a family doing the same thing, so the dark feels shared.", ok: true, why: "Strong. It explains the comparison and its effect." },
      { t: "The people in the other flats have aquariums with lights in them that can be seen through the curtains at night.", why: "A literal misreading of the comparison." },
      { t: "The writer compares the torches to fish in this sentence, which is a simile, a comparison that uses the word like to join two things.", why: "An observation. Why that comparison?" }
    ]
  },
  {
...
const ANNOTATE = [
  ...
  {
    skill: "Word choice",
    prompt: "Find the invented word Lear uses for the spoon the couple eat with.",
    target: ["a runcible spoon"],
    decoys: [{ phrase: "slices of quince", why: "Quince is a real fruit. Look instead for the made-up word describing the spoon itself." }],
    miss: "Look in the third stanza, in the line about mince and quince.",
    explain: "“Runcible” is a word Lear invented; it does not exist outside his poems. It fits the poem's playful, nonsense world, where even an ordinary object can be given a made-up name."
  },
  {
    skill: "Structure",
...
const QUESTIONS = [
  ...
  {
    skill: "Effect of repetition",
    q: "What is the effect of repeating the last line of the first stanza three times?",
    opts: [
      { t: "It makes the Owl's song sound musical, like a real refrain being sung out loud", ok: true, why: "Right. Shortening the line each time (“You are, / You are!”) mimics the sound of a song trailing off, fitting since the Owl is singing to a guitar." },
      { t: "It shows that the Owl has already forgotten what it wanted to say to Pussy", why: "The Owl repeats the exact same compliment on purpose. Forgetting would mean saying something different each time instead." },
      { t: "It proves that Pussy did not hear the Owl properly the first two times he sang", why: "Nothing in the poem suggests Pussy is hard of hearing. The repetition is simply part of the song's structure." },
      { t: "It slows the poem right down so readers have time to learn a difficult new word", why: "There is no new or difficult word in this repeated line, just a simple compliment being sung again." }
    ]
  },
  {
    skill: "Word choice",
...
const EVIDENCE = [
  ...
  {
    quote: "Which they ate with a runcible spoon",
    opts: [
      { t: "The poem invents its own playful objects, rather than only using real, ordinary ones", ok: true, why: "Right. A “runcible spoon” does not exist in real life; it belongs to the poem's own invented, nonsense world." },
      { t: "A runcible spoon is a real, old-fashioned type of spoon once used for eating quince", why: "Lear made this word up. It is not a real historical type of spoon at all." },
      { t: "The wedding feast is eaten with completely ordinary spoons, just like any everyday meal", why: "The spoon is specifically called “runcible”, an invented word, not an ordinary everyday one." },
      { t: "The spoon is magical and lets whoever holds it understand what animals are saying", why: "The poem gives the spoon no magic powers. It is simply an invented, playful word." }
    ]
  },
  {
...
const EXPLAIN = [
  {
    claim: "The refrain gives the poem a musical, song-like quality.",
    quote: "What a beautiful Pussy you are",
    opts: [
      { t: "The Owl sings a love song to Pussy while playing a small guitar together on the boat, right at the very start of the first stanza in the poem.", why: "Retelling. Explain what repeating this particular line does, not just what happens in the scene." },
      { t: "Repeating and shortening this line (“You are, / You are!”) mimics the fading final notes of a real song, since the Owl is singing it aloud.", ok: true, why: "Strong. It links the shrinking repetition to the sound of a song ending, and to the fact the Owl is literally singing." },
      { t: "The writer repeats a line near the start of the poem for some kind of effect, though it is never made fully clear here.", why: "Too general. Which effect, and how exactly does the repetition create it?" },
      { t: "This proves the Owl cannot think of anything else nice at all to say to Pussy, since it just repeats the same words.", why: "A misreading. The repetition is a musical device, not a sign the Owl has run out of things to say." }
    ]
  },
  {
